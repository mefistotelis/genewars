...
typedef enum DeathRayType DeathRayType;
...
typedef enum EtherealPunishment EtherealPunishment;
...
typedef enum EtherealMode EtherealMode;
...
typedef enum EtherealType EtherealType;
...
class Ethereal : SmartMovingThing { // sizeof=102
    ...
    void UpdatePutt();
    void UpdateSaucer();
    SLONG WriteBuffer(Ethereal **arg1, SLONG arg2, SLONG arg3, BioGame *arg4);
    SLONG ReadBuffer(Ethereal **arg1, SLONG arg2, SLONG arg3, BioGame *arg4);
    void UpdateAll();
